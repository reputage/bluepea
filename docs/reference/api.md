...
Endpoint URL summary [index](#endpoint-url-summary)  
...
/agent?did={did} GET [api](#agent-read)  
/agent?all=true GET [api](#agent-read-query-all)  
/agent?all=true&issuer=true GET [api](#agent-read-query-all)  

Issuer Agent  
/agent  POST   [api](#issuer-agent-creation)  
/agent?did={did} GET [api](#issuer-agent-read)  

/agent/{did}  GET  [api](#agent-read-by-did)  
/agent/{did}  PUT  [api](#agent-write-by-did)  


/thing  POST  [api](#thing-creation)  
/thing?did={did} GET  [api](#thing-read-query)  
/thing?hid={hid} GET  [api](#thing-read-query)  
/thing?all=true GET  [api](#thing-read-query-all)  

/thing/{did}  GET  [api](#thing-read-by-did)  
/thing/{did}  PUT  [api](#thing-write-by-did)  


/agent/{did}/drop  POST  [api](#writing-a-message-from-one-agent-to-another)  
/agent/{did}/drop?from={did}&uid={muid}  GET  [api](#reading-a-message-from-one-agent-to-another)  
/agent/{did}/drop?all=true  GET  [api](#drop-read-list-query)  

including encrypted data in a message  [api](#including-encrypted-data-in-a-message)  

/thing/{did}/offer  POST  [api](#offer-to-transfer-control-write-request)  
/thing/{did}/offer?uid={ouid}  GET  [api](#offer-to-transfer-control-read-request)  

/thing/{did}/accept?uid={ouid}  POST  [api](#offer-to-transfer-control-accept-request)  

/thing/{did}/offer?all=true  GET  [api](#offer-read-list-query)   
/thing/{did}/offer?latest=true  GET  [api](#offer-read-list-query)

/anon  POST  [api](#anonymous-message-creation)  
/anon?uid={uid}  GET  [api](#anonymous-message-read)  
/anon?all=true  GET   [api](#anonymous-message-uid-list-read-query)  
...
## Writing a *Message* from One *Agent* to Another 
...
### *Offer* to Tranfer Control Write Request
...
### *Anonymous Message UID* List Read Query
